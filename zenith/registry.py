"""Dynamic plugin registry for Zenith-Sentry detectors."""
...
class PluginRegistry:
    """Dynamically loads and manages detector plugins."""
    ...
    def load_plugins(self):
        """Discover and load all detector plugins from zenith/plugins/."""
    ...
    def _load_plugin_file(self, filename: str):
        ...
        Args:
            filename: Plugin filename without path
            
        Raises:
            Exception: If module loading or inspection fails
        """
    ...
    def instantiate(self, **kwargs) -> list:
        """Instantiate all loaded detectors with given kwargs.
        
        Args:
            **kwargs: Arguments passed to detector constructors
            
        Returns:
            list: Instantiated detector objects
        """
        detectors = []
