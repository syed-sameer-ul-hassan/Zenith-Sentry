...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Kernel-4.8+-red?style=flat-square" alt="Kernel"/>
  <img src="https://img.shields.io/badge/License-MIT-green?style=flat-square" alt="MIT License"/>
  <img src="https://img.shields.io/badge/MITRE-ATT%26CK-purple?style=flat-square" alt="MITRE ATT&CK"/>
  <img src="https://img.shields.io/badge/eBPF-Enabled-brightgreen?style=flat-square" alt="eBPF"/>
</p>
    ...
    └────────────┬──────────────────┘
          ...
          (with error isolation)
           ...
           Aggregate Risk Score (0–100)
                 │
                 ▼
     user_data/scan_<YYYYMMDD_HHMMSS>.json
```
